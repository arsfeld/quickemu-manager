...
echo "Starting QEMU with SPICE server on port $SPICE_PORT..."
...
exec qemu-system-x86_64 \
    ...
    -spice port=$SPICE_PORT,addr=0.0.0.0,disable-ticketing=on,image-compression=off,streaming-video=all \
