...
impl SpiceClient {
    ...
    pub fn new_with_password(websocket_url: String, canvas: HtmlCanvasElement, password: String) -> Self {
        console_error_panic_hook::set_once();
        
        console::log_1(&format!("Creating new SPICE client for {} with password", websocket_url).into());
