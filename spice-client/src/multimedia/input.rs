...
pub enum KeyboardEvent {
    KeyDown { scancode: u32, keycode: Option<u32>, modifiers: u32 },
    KeyUp { scancode: u32, keycode: Option<u32>, modifiers: u32 },
}
...
#[derive(Debug, Clone, Copy)]
pub enum MouseEvent {
    Motion { x: u32, y: u32, relative_x: i32, relative_y: i32 },
    Button { button: MouseButton, pressed: bool, x: u32, y: u32 },
